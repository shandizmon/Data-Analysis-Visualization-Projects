...
d3.csv("data/data.csv", function(err, healthData) {
    ...
    yMin = d3.min(healthData, function(data) {
        return +data.healthStatus * 0.98;
    });

    yMax = d3.max(healthData, function(data) {
        return +data.healthStatus *1.02;
    });
    ...
    chart.append("text")
        ...
        .append("tspan")
            ...
            .attr("y", function(data) {
                return yLinearScale(data.healthStatus - 0.2);
            })
            .text(function(data) {
                return data.abbr
            });
    ...
    chart
        ...
        .attr(
            "transform",
            "translate(" + width / 3 + " ," + (height + margin.top + 30) + ")"
        )
        .attr("class", "axis-text")
        .text("In Poverty (%)");
    });
